...
class Calendar {
    ...
    monthdays2( year, month, orderDays ) {
        //"""
        ...
        var date_queue = this.monthdates( year, month ).map( function( date ) {
            ...
            if(orderDays&&orderDays.indexOf(util.formatDate(date))!=-1){
                dat[3]=true;
            }else{
                dat[3]=false;
            }
    ...
    monthdays2calendar( year, month,orderDays ) {
        // """
        ...
        // are zero.
        // """
        var days = this.monthdays2( year, month ,orderDays)
